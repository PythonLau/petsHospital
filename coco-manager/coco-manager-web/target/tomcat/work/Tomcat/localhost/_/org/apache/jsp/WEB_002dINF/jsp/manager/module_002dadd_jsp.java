 ...
 * Generated at: 2017-05-19 12:13:39 UTC
...
public final class module_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<div>\r\n");
      out.write("    <ul id=\"positionCat\" class=\"easyui-tree\">\r\n");
      out.write("    </ul>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"positionCatMenu\" class=\"easyui-menu\" style=\"width:120px;\" data-options=\"onClick:menuHandler\">\r\n");
      ...
      out.write("                    // 新增节点\r\n");
      out.write("                    $.post(\"/manager/module/create\",{parentId:node.parentId,name:node.text},function(data){\r\n");
      ...
      out.write("                    });\r\n");
      out.write("                }else{\r\n");
      out.write("                    $.post(\"/manager/module/update\",{id:node.id,name:node.text});\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("    function menuHandler(position){\r\n");
      out.write("        var tree = $(\"#positionCat\");\r\n");
      out.write("        var node = tree.tree(\"getSelected\");\r\n");
      out.write("        if(position.name === \"add\"){\r\n");
      ...
      out.write("        }else if(position.name === \"rename\"){\r\n");
      out.write("            tree.tree('beginEdit',node.target);\r\n");
      out.write("        }else if(position.name === \"delete\"){\r\n");
      out.write("            $.messager.confirm('确认','确定删除名为 '+node.text+' 的分类吗？',function(r){\r\n");
      out.write("                if(r){\r\n");
      out.write("                    $.post(\"/manager/module/delete/\",{id:node.id},function(data){\r\n");
      out.write("                        if(data.status == 200){\r\n");
      ...
      out.write("                }\r\n");
      out.write("            });\r\n");
      out.write("        }else if(position.name === \"alter\"){\r\n");
      out.write("            $.messager.confirm('确认','确定要设置 '+node.text+' 为可挂号吗？',function(r){\r\n");
      out.write("                if(r){\r\n");
      out.write("                    $.post(\"/position/cat/alterStatus/\",{id:node.id},function(data){\r\n");
      out.write("                        if(data.status == 200){\r\n");
      out.write("                            $.messager.alert('提示',data.msg);\r\n");
      out.write("                        }else if(data.status == 500){\r\n");
      out.write("                            $.messager.alert('提示',data.msg);\r\n");
