...
<table class="easyui-datagrid" id="packageList" title="报表列表"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/manager/module/edit/list',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
    <tr>
        <th data-options="field:'ck',checkbox:true"></th>
        <th data-options="field:'id',width:133">报表ID</th>
        <th data-options="field:'name',width:123">报表名称</th>
        <th data-options="field:'url',width:188">报表链接</th>
        <th data-options="field:'sortOrder',width:68">排列序号</th>
        <th data-options="field:'parentId',width:68">父目录</th>
        <th data-options="field:'isParent',width:68,formatter:TAOTAO.formatIisParentStatus">是否父目录</th>
        <th data-options="field:'status',width:68,align:'center',formatter:TAOTAO.formatModuleStatus">报表状态</th>
