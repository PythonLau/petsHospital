...
<table class="easyui-datagrid" id="accountList" title="病历列表"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/manager/doctorAccount/list',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
    <tr>
        <th data-options="field:'ck',checkbox:true"></th>
        <th data-options="field:'id',width:138">用户id</th>
        <th data-options="field:'username',width:138">登录名</th>
...
<div id="accountWindow" class="easyui-window" title="重置密码" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/manager/account-edit'" style="width:80%;height:80%;padding:10px;">
</div>
