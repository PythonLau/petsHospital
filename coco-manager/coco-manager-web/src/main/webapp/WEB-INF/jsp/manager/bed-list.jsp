...
<table class="easyui-datagrid" id="accountList" title="床位列表"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/manager/bed/list',method:'get',pageSize:10,toolbar:toolbar">
    <thead>
    <tr>
        <th data-options="field:'ck',checkbox:true"></th>
        <th data-options="field:'id',width:138">床位id</th>
        <th data-options="field:'name',width:138">床位名称</th>
        <th data-options="field:'status',width:88,formatter:TAOTAO.formatBedStatus">状态</th>
