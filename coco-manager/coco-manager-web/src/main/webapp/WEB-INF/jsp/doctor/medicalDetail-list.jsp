...
<div id="prescribeWindow" class="easyui-window" title="治疗" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/doctor/medicalDetail-edit'" style="width:80%;height:80%;padding:10px;">
</div>
<script>
